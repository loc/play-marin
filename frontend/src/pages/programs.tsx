...
export default function Programs({
	...
	function programPhoto(program: { photo: { url: string }; name: string }) {
		if (program.photo) {
			return (
				<div
					className={styles['program-photo']}
	...
	function pageContent() {
		return (
			<DefaultPageWrap activeMenuItem="programs" isPreview>
		...
		return (
			<div>
				...
				<div className={styles['program-filter']}>
					<Link href="/">
						<button className={styles['buttonsprimary']}>
							SIGN UP ON TEAM SNAP
						</button>
					</Link>
					<ul>
				...
				<div className={styles['program-footer-text-block']}>
					<p>
						Check our calendar and follow our social channels for more
						partnership sports and activities such as Flag Football, Rowing, and
						more!
					</p>
				</div>
			</div>
